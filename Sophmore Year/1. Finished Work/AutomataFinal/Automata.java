/*
Name of Program: Automata
Programmer: Jack Bergin
Class Block: E
Date Completed: 2/17/17
Description of what program does: 
This program will make a random cool 
pattern based on the pattern you 
enter off of 1s and 0s.
*/
   ...
   public static void main(String[] args)   
   {
      ...
      while (count != times)
      {
         ...
         for (int j = 1; j <= 800; j++)
         {
            ...
            if ((arrayTop[99] == 0 && arrayTop[0] == 0 
                && arrayTop[1] == 0 && ruleSet[0] == 1) ||
                (arrayTop[99] == 1 && arrayTop[0] == 1 
                && arrayTop[1] == 1 && ruleSet[1] == 1) ||
                (arrayTop[99] == 1 && arrayTop[0] == 0 
                && arrayTop[1] == 0 && ruleSet[2] == 1) ||
                (arrayTop[99] == 0 && arrayTop[0] == 0 
                && arrayTop[1] == 1 && ruleSet[3] == 1) ||
                (arrayTop[99] == 1 && arrayTop[0] == 1 
                && arrayTop[1] == 0 && ruleSet[4] == 1) ||
                (arrayTop[99] == 0 && arrayTop[0] == 1 
                && arrayTop[1] == 1 && ruleSet[5] == 1) ||
                (arrayTop[99] == 1 && arrayTop[0] == 0 
                && arrayTop[1] == 1 && ruleSet[6] == 1) ||
                (arrayTop[99] == 0 && arrayTop[0] == 1 
                && arrayTop[1] == 0 && ruleSet[7] == 1))
            {
            ...
            {
               if ((arrayTop[i-1] == 0 && arrayTop[i] == 0 
                && arrayTop[i+1] == 0 && ruleSet[0] == 1)||
                (arrayTop[i-1] == 1 && arrayTop[i] == 1 
                && arrayTop[i+1] == 1 && ruleSet[1] == 1)||
                (arrayTop[i-1] == 1 && arrayTop[i] == 0 
                && arrayTop[i+1] == 0 && ruleSet[2] == 1)||
                (arrayTop[i-1] == 0 && arrayTop[i] == 0 
                && arrayTop[i+1] == 1 && ruleSet[3] == 1)||
                (arrayTop[i-1] == 1 && arrayTop[i] == 1 
                && arrayTop[i+1] == 0 && ruleSet[4] == 1)||
                (arrayTop[i-1] == 0 && arrayTop[i] == 1 
                && arrayTop[i+1] == 1 && ruleSet[5] == 1)||
                (arrayTop[i-1] == 1 && arrayTop[i] == 0 
                && arrayTop[i+1] == 1 && ruleSet[6] == 1)||
                (arrayTop[i-1] == 0 && arrayTop[i] == 1 
                && arrayTop[i+1] == 0 && ruleSet[7] == 1))
               {
            ...
            if ((arrayTop[98] == 0 && arrayTop[99] == 0 
             && arrayTop[0] == 0 && ruleSet[0] == 1)||
             (arrayTop[98] == 1 && arrayTop[99] == 1 
             && arrayTop[0] == 1 && ruleSet[1] == 1)||
             (arrayTop[98] == 1 && arrayTop[99] == 0 
             && arrayTop[0] == 0 && ruleSet[2] == 1)||
             (arrayTop[98] == 0 && arrayTop[99] == 0 
             && arrayTop[0] == 1 && ruleSet[3] == 1)||
             (arrayTop[98] == 1 && arrayTop[99] == 1 
             && arrayTop[0] == 0 && ruleSet[4] == 1)||
             (arrayTop[98] == 0 && arrayTop[99] == 1 
             && arrayTop[0] == 1 && ruleSet[5] == 1)||
             (arrayTop[98] == 1 && arrayTop[99] == 0 
             && arrayTop[0] == 1 && ruleSet[6] == 1)||
             (arrayTop[98] == 0 && arrayTop[99] == 1 
             && arrayTop[0] == 0 && ruleSet[7] == 1))
            {
