/*
Project Name:DrawHourglass
Programmer:Jack Bergin
Class:Computer Science
Date:10/14/16
Description:Print out a figure of any size that is in a shape of an hour glass.
*/
...
public class DrawHourglass 
{
   ...
   // This blerb is just like the prior but will print the 
   //bottom half of the hr glass figure
