...
public class QuizMakerJack
{
   public static void main(String[] args) 
   {
      ...
      quest[1] = "How much time does a player have to clear the definsive and offinsive zone properly";
      quest[2] = "How do you properly set up a faceoff?";
      ...
      answ[2] = "A. There is no faceoff B. The reff will say set up on my foot, down, set, go! C. Just say go D. The reff will say set up on my foot, down, set, (blows whistle)!";
